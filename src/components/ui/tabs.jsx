...
function TabsList({ className, ...props }) {
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "bg-muted text-muted-foreground  inline-flex h-9 w-[471px] items-center justify-center rounded-full p-[3px]",
        className
      )}
      {...props}
    />
